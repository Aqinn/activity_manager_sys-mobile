 ...
 */
public class CreateAttendDialogBuilder extends QMUIDialogBuilder<CreateAttendDialogBuilder> {
    ...
    public CreateAttendDialogBuilder(Context context) {
        super(context);
    }
    ...
    protected View onCreateContent(@NonNull QMUIDialog dialog, @NonNull QMUIDialogView parent, @NonNull Context context) {
        View content = dialog.getLayoutInflater().inflate(R.layout.fragment_create_attend, null);
